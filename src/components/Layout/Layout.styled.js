...
const animaCardTheme = keyframes`
	0% { bottom: -80px; }
	30% { bottom: 25px; }
	60% { bottom: 15px; }
	100% { bottom: 20px; }
`
const animaCardThemeSm = keyframes`
	0% { bottom: -80px; }
	30% { bottom: 20px; }
	60% { bottom: 10px; }
	100% { bottom: 15px; }
...
export const CardTheme = styled.div`
	...
	animation: ${animaCardTheme} 0.7s 5s forwards cubic-bezier(0.5, 1, 0.89, 1); 

	@media (max-width: ${props => props.theme.sizes.sm}) {
		left: 20px;
		bottom: -80px;
		animation: ${animaCardThemeSm} 0.7s 5s forwards cubic-bezier(0.5, 1, 0.89, 1); 
	}
