          ...
          <Main>
            ...
            <motion.div className="section-text" exit={exit}>
              ...
              >
                ...
                <br />
                <br />
                Con muchos deseos de mejorar mi experiencia y conocimientos, que
                sea un apasionado por su trabajo y tenga muchas ganas de
            ...
            <motion.div exit={exit} className="button-return">
